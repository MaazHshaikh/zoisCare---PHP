<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "DELETE FROM `doctor` WHERE `doctor_id` = '$docid'";
    ...
    <div>
      <form action="delDoc.php" method="post">
          ...
          <h2>
            ...
            <h3><input type="text" class="form-control" id="docid" name="docid" placeholder="Doctor ID to delete"></h3>
          </h2>
        </div>
      </li>
      <li class="contact-item">
        <div>
          <br>
          <h2>
            <button type="submit"  class="btn has-before title-md" name="button">Delete Doctor</button>
          </h2>
    </form>
    </div>
  </li>
