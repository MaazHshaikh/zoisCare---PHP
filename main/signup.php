<?php
    ...
    if ($role == 'Admin'){
        $sql = "INSERT INTO `zoisCare`.`admin` (`name`, `address`, `phone`, `email`, `username`, `password`) VALUES ('$name', '$address', '$phone', '$email', '$username', '$password')";
        $result = mysqli_query($conn, $sql);
    }

    elseif ($role == 'Patient'){
        $sql = "INSERT INTO `zoisCare`.`patient` (`name`, `address`, `phone`, `email`, `username`, `password`) VALUES ('$name', '$address', '$phone', '$email', '$username', '$password')";
        $result = mysqli_query($conn, $sql);
    }

    elseif ($role == 'Doctor'){
        $sql = "INSERT INTO `zoisCare`.`doctor` (`name`, `address`, `phone`, `email`, `username`, `password`,  `specialization`, `availability`) VALUES ('$name', '$address', '$phone', '$email', '$username', '$password', '$specialization', '$availability')";
        $result = mysqli_query($conn, $sql);
    }
    if ($result) {
