  ...
  <footer class="footer" style="background-image: url('css/footer-bg.png')">
    ...
    <div>
      ...
      <h2>
        ...
        <h3><input type="text" class="form-control" id="docid" name="docid" placeholder="Enter your Doctor ID"></h3>
      </h2>
      <h2>
  ...
  <li class="contact-item">
    <div>
      <h2>
        ...
        <h3><input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your phone"></h3>
      </h2>
      <h2>
      ...
      <br>
      <h2>
        <button type="submit"  class="btn has-before title-md" name="button">Make Changes</button>
      </h2>
    </form>
    </div>
  </li>
