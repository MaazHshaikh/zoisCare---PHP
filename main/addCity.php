        ...
        <div class="footer-brand" data-reveal="bottom">
          ...
          <ul class="contact-list has-after">
            ...
            <li class="contact-item">
              <div>
                <h2>
                  <label for="city" class="form-label">Add a city</label>
                  <h3><input type="text" class="form-control" id="city" name="city" placeholder="Enter your city"></h3>
                </h2>
                <h2>
                ...
                <h2>
                  <button type="submit"  class="btn has-before title-md" name="button">Add city</button>
                </h2>
              </form>
              </div>
